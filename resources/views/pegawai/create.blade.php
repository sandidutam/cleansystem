                ...
                <div class="col">
                    ...
                    <div class="card mb-3" style="height: 100%">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-2 {{$errors->has('kelurahan') ? 'has-error' : ''}} ">
                                ...
                                <div class="form-group col {{$errors->has('kecamatan') ? 'has-error' : ''}} ">
                                ...
                                <div class="form-group col {{$errors->has('kota_kabupaten') ? 'has-error' : ''}} ">
                                ...
                                <div class="form-group col {{$errors->has('provinsi') ? 'has-error' : ''}} ">
                ...
                <div class="col">
                    ...
                    <div class="card mb-3" style="height: 100%">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col {{$errors->has('pendidikan') ? 'has-error' : ''}} ">
