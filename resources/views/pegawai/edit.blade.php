...
@section('content')
    ...
    <div class="card shadow mb-4" >
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Form Edit Data {{$data_pegawai->nama_lengkap}}</h6>
        </div>
        ...
        {{-- <div class="row mt-2" style="margin-bottom: 20px">
            <div class="col">
                <h1 class="text-center">Form Edit Data Pegawai {{$data_pegawai->nama_lengkap}}</h1>
            </div>
        </div> --}}
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group {{$errors->has('foto_pegawai') ? 'has-error' : ''}} "> 
                            <div class="mb-3">
                                ...
                                {{-- {!! Form::text('foto_pegawai', null, ['class'=>'form-control','id'=>'foto_pegawai','type'=>'file']) !!} --}}
                                <input class="form-control" type="file" name="foto_pegawai" id="foto_pegawai" value="{{old('foto_pegawai')}}">
