...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h4 class="m-0 font-weight-bold text-center text-primary">Form Presensi Masuk</h4>
    </div>
    ...
    <div class="card-body">
        ...
        <div class="row mb-2 justify-content-center">
                ...
                <button type="submit" class="btn btn-success mx-3" name="btn_masuk" style="width: 10rem" value="btn_masuk" >PRESENSI MASUK</button>
            
                
                <button type="submit" class="btn btn-danger mx-3" name="btn_absen" style="width: 10rem" value="btn_absen">ABSEN</button>
        ...
        {{-- <div class="row justify-content-center">
            <div class="col-6">
                <div class="row justify-content-center">
                    <button type="submit" class="btn btn-primary" name="btn_keterangan" style="width: 22rem" value="btn_keterangan">SUBMIT KETERANGAN</button>
                </div>
                <div class="row">
                    <small id="helpId" class="fst-italic text-center text-muted"> <span class=" fw-bold text-danger">Perhatian!</span> Submit keterangan apabila pegawai tidak masuk kerjasmall>
                </div>
            </div>
        </div> --}}
